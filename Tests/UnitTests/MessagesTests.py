...
class MessageTests(unittest.TestCase):
    ...
    def test_bad_send_message_and_get_messages_of_users(self):
        UsersLogic.register(RegisteredUser('TomerTomer', '1234567878'))
        UsersLogic.register(RegisteredUser('ShaharShahar', '1234567878'))
        self.assertFalse(MessagingLogic.send_message(Message(1, 'TomerTomer1', 'ShaharShahar', 'Hello 1')))
        self.assertFalse(MessagingLogic.send_message(Message(2, 'ShaharShahar1', 'TomerTomer', 'Hello 2')))
