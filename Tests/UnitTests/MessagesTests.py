...
class MessageTests(unittest.TestCase):
    ...
    def test_send_message_and_get_messages_of_shops(self):
        ...
        UsersLogic.add_manager('TomerTomer1', StoreManager('TomerTomer2', 'My Shop1', 1, 1, 1, 1, 1, 1, 1, 1))
        UsersLogic.add_manager('TomerTomer2', StoreManager('TomerTomer1', 'My Shop2', 1, 1, 1, 1, 1, 1, 1, 1))
