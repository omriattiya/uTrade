...
class MessageTests(unittest.TestCase):
    ...
    def test_send_message_and_get_messages_of_users(self):
        UsersLogic.register(RegisteredUser('TomerTomer', '12345678'))
        UsersLogic.register(RegisteredUser('ShaharShahar', '12345678'))
    ...
    def test_send_message_and_get_messages_of_shops(self):
        register(RegisteredUser('TomerTomer1', '12345678'))
        shop1 = Shop('My Shop1', 'ACTIVE')
        ShopLogic.create_shop(shop1, 'TomerTomer1')
        register(RegisteredUser('TomerTomer2', '12345678'))
        shop2 = Shop('My Shop2', 'ACTIVE')
        ShopLogic.create_shop(shop2, 'TomerTomer2')
        UsersLogic.add_manager('TomerTomer1', StoreManager('TomerTomer2', 'My Shop1', 1, 1, 1, 1, 1, 1))
        UsersLogic.add_manager('TomerTomer2', StoreManager('TomerTomer1', 'My Shop2', 1, 1, 1, 1, 1, 1))
